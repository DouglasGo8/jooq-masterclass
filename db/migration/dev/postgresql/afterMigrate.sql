...
insert into "office"("office_code", "city", "phone", "address_line_first", "address_line_second", "state", "country",
                     "postal_code", "territory", "internal_budget")
values ('1', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', 'AZ934VB', 'NA', 90000),
...
insert into "department"("department_id", "name", "phone", "code", "office_code", "topic", "local_budget", "profit",
                         "forecast_profit", "cash", "accounts_receivable", "inventories", "accounts_payable",
                         "st_borrowing", "accrued_liabilities")
values ('1', 'Advertising', '-int 4782', '1333', '1', ARRAY ['publicity', 'promotion'], NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL),

       ('2', 'Sales', '-int 41233', '1441', '1', ARRAY ['commerce', 'trade', 'sellout', 'transaction'], 650000, 900000,
        800000, 20000, NULL, 10000, NULL, NULL, NULL),

       ('3', 'Accounting', '-int 8233', '2311', '2', ARRAY ['monetary', 'business'], NULL, 450000, NULL, 25000, NULL,
        NULL, NULL, NULL, NULL),

       ('4', 'Finance', '-int 4421', '3229', '3', ARRAY ['commerce', 'fiscal', 'monetary', 'business'], 120000, 90000,
        NULL, NULL, NULL, NULL, 40000, 10000, NULL),

       ('5', 'Sales', '-int 34443', '6554', '2', ARRAY ['commerce', 'sellout', 'transaction'], 345000, 350000, 450000,
        11000, 25000, 5000, 10000, 85000, 12000),

       ('6', 'Sales', '-int 7664', '1234', '4', NULL, NULL, 100000, NULL, NULL, NULL, NULL, 50000, NULL, NULL),

       ('7', 'Marketing', '-int 1266', '9090', '4', ARRAY ['market', 'research', 'advertising'], NULL, 500000, 250000,
        NULL, 11000, NULL, 5000, NULL, 1000),

       ('8', 'Marketing', '-int 4543', '4544', '5', ARRAY ['market', 'research', 'advertising'], NULL, 430000, 900000,
        NULL, NULL, NULL, NULL, NULL, NULL),

       ('9', 'Assembly', '-int 8777', '5455', '6', ARRAY ['gathering', 'construction', 'joining'], 500000, 500000,
        450000, NULL, NULL, NULL, 7000, NULL, NULL),

       ('10', 'Accounting', '-int 6765', '4555', '6', ARRAY ['monetary', 'business'], NULL, NULL, 100000, 10000, NULL,
        NULL, 4000, NULL, NULL),

       ('11', 'Finance', '-int 1111', '7876', '7', ARRAY ['commerce', 'fiscal', 'monetary', 'business'], 450000, NULL,
        450000, NULL, NULL, NULL, NULL, NULL, NULL),

       ('12', 'Logistics', '-int 4421', '3222', '8', ARRAY ['facilities', 'supplies'], NULL, 120000, 300000, 10000,
        NULL, 11000, NULL, 16000, NULL),

       ('13', 'Logistics', '-int 7453', '7884', '9', ARRAY ['facilities', 'supplies'], NULL, 80000, 100000, 9000, NULL,
        6000, 2300, 4400, NULL),

       ('14', 'Logistics', '-int 3433', '6777', '12', ARRAY ['facilities', 'supplies'], 235000, 233000, NULL, NULL,
        NULL, 1000, NULL, NULL, 9000),

       ('15', 'HR', '-int 2323', '7888', '12', ARRAY ['people', 'interview', 'hiring'], NULL, 120000, 120000, NULL, 544,
        NULL, NULL, 2300, NULL)
ON CONFLICT ("department_id") DO NOTHING;

/* Data for the table "manager" */

insert into "manager"("manager_id", "manager_name", "manager_evaluation", "manager_detail")
values ('1', 'Joana Nimar', (67, 34, 33, 66),
...
insert into "office_has_manager"("offices_office_code", "managers_manager_id")
values ('1', '1'),
       ...
       ('7', '2')
ON CONFLICT ("offices_office_code", "managers_manager_id") DO NOTHING;

/* Data for the table "employee" */

insert into "employee"("employee_number", "last_name", "first_name", "extension", "email", "office_code", "salary",
                       "commission", "reports_to", "job_title", "employee_of_year", "monthly_bonus")
values (1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', 120000, 10000, NULL, 'President', NULL,
        ARRAY [450, 210, 222, 123, 110, 0, 0, 0, 560, 440, 315, 125, 0, 900]),

       (1056, 'Patterson', 'Mary', 'x4611', 'mpatterso@classicmodelcars.com', '1', 100000, 5000, 1002, 'VP Sales', NULL,
        NULL),

       (1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 100000, 3500, 1002, 'VP Marketing',
        NULL, ARRAY [0, 0, 0, 125, 125, 150, 232, 100, 0]),

       (1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 80000, NULL, 1056,
        'Sales Manager (APAC)', NULL, ARRAY [560, 120, 440, 320, 315, 0, 0, 100, 125, 0, 900]),

       (1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', 80000, NULL, 1056,
        'Sales Manager (EMEA)', NULL, NULL),

       (1143, 'Bow', 'Anthony', 'x5428', 'abow@classicmodelcars.com', '1', 75000, 5000, 1056, 'Sales Manager (NA)',
        NULL, NULL),

       (1165, 'Jennings', 'Leslie', 'x3291', 'ljennings@classicmodelcars.com', '1', 60000, NULL, 1143, 'Sales Rep',
        ARRAY [2003, 2004], NULL),

       (1166, 'Thompson', 'Leslie', 'x4065', 'lthompson@classicmodelcars.com', '1', 60000, NULL, 1143, 'Sales Rep',
        ARRAY [2003, 2005], NULL),

       (1188, 'Firrelli', 'Julie', 'x2173', 'jfirrelli@classicmodelcars.com', '2', 60000, NULL, 1143, 'Sales Rep',
        ARRAY [2004, 2005], NULL),

       (1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '2', 55000, 1000, 1143, 'Sales Rep',
        ARRAY [2005, 2006], NULL),

       (1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '3', 55000, 2000, 1143, 'Sales Rep',
        ARRAY [2002, 2003, 2004], NULL),

       (1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '3', 55000, 1500, 1143, 'Sales Rep',
        ARRAY [2000, 2001, 2005], NULL),

       (1337, 'Bondur', 'Loui', 'x6493', 'lbondur@classicmodelcars.com', '4', 60000, NULL, 1102, 'Sales Rep',
        ARRAY [2004, 2007], NULL),

       (1370, 'Hernandez', 'Gerard', 'x2028', 'ghernande@classicmodelcars.com', '4', 65000, NULL, 1102, 'Sales Rep',
        ARRAY [2000, 2001], NULL),

       (1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', 55000, NULL, 1102, 'Sales Rep',
        ARRAY [2000, 2001, 2003, 2005], NULL),

       (1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', 50000, 1000, 1102, 'Sales Rep',
        ARRAY [2004, 2008], NULL),

       (1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '7', 50000, 500, 1102, 'Sales Rep',
        ARRAY [2002, 2003, 2005], NULL),

       (1611, 'Fixter', 'Andy', 'x101', 'afixter@classicmodelcars.com', '6', 50000, 1000, 1088, 'Sales Rep',
        ARRAY [2002, 2005], NULL),

       (1612, 'Marsh', 'Peter', 'x102', 'pmarsh@classicmodelcars.com', '6', 55000, NULL, 1088, 'Sales Rep',
        ARRAY [2003, 2005, 2006, 2007], NULL),

       (1619, 'King', 'Tom', 'x103', 'tking@classicmodelcars.com', '6', 60000, 1000, 1088, 'Sales Rep',
        ARRAY [2002, 2004], NULL),

       (1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', 55000, 2000, 1056, 'Sales Rep',
        ARRAY [2003, 2005], NULL),

       (1625, 'Kato', 'Yoshimi', 'x102', 'ykato@classicmodelcars.com', '5', 60000, 2500, 1621, 'Sales Rep',
        ARRAY [2004, 2005, 2006], NULL),

       (1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '4', 50000, 3400, 1102, 'Sales Rep',
        ARRAY [2005, 2007], NULL)
ON CONFLICT ("employee_number") DO NOTHING;

/* Data for the table "customer" */

insert into "customer"("customer_number", "customer_name", "contact_last_name", "contact_first_name", "phone",
                       "sales_rep_employee_number", "credit_limit", "first_buy_date")
values (99, 'Australian Home', 'Paoule', 'Sart ', '40.11.2555', 1370, '21000.00', 20210),
...
insert into "customerdetail"("customer_number", "address_line_first", "address_line_second", "city", "state",
                             "postal_code", "country")
values (99, '43 Rue 2', NULL, 'Paris', NULL, '25017', 'France'),
...
insert into "productline"("product_line", "code", "text_description", "html_description", "image", "created_on")
values ('Classic Cars', 599302,
        ...
        '<productline><name>Classic Cars</name><code>599302</code><capacity supportClass="a, b, c"><a index="200A">200</a><b index="100B">100</b><c index="500C">500<note for="client">This has certain limitations</note></c></capacity><details><power>5000kw</power><type nr_of_lines="5" command="ERP">1</type></details></productline>',
        NULL, '2005-02-03'),
       ...
       ('Motorcycles', 599302,
        ...
        '<productline><name>Motorcycles</name><code>599302</code><capacity supportClass="a, b"><a index="250A">200</a><b index="150B">100</b></capacity><details><power>2000kw</power><type nr_of_lines="3" command="OPS">2</type></details></productline>',
        NULL, '2004-12-12'),
       ...
       ('Ships', 433823,
        ...
        NULL, NULL, '2005-12-12'),

       ('Trains', 123333,
        'Model trains are a rewarding hobby for enthusiasts of all ages. Whether you''re looking for collectible wooden trains, electric streetcars or locomotives, you''ll find a number of great choices for any budget within this category. The interactive aspect of trains makes toy trains perfect for young children. The wooden train sets are ideal for children under the age of 5.',
        '<productline><name>Trains</name><code>123333</code><capacity supportClass="a, b, b1, c"><a index="250A">200</a><b index="150B">100<b1 index="300B">300</b1></b><c index="350B">350</c></capacity><details><power>20000kw</power><type nr_of_lines="1" command="ERP">1</type></details></productline>',
        NULL, '2004-03-03'),
       ...
       ('Vintage Cars', 223113,
        ...
        NULL, NULL, '2004-04-02')
ON CONFLICT ("product_line") DO NOTHING;

/* Data for the table "productlinedetail" */

insert into "productlinedetail"("product_line", "code", "line_capacity", "line_type")
values ('Classic Cars', 599302, '200A', 1),
...
insert into "product"("product_id", "product_name", "product_line", "code", "product_scale", "product_vendor",
                      "product_description", "quantity_in_stock", "buy_price", "msrp")
values (1, '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', 599302, '1:10', 'Min Lin Diecast', 'PENDING', 7933,
        '48.81', '95.70'),

       (2, '1952 Alpine Renault 1300', 'Classic Cars', 599302, '1:10', 'Classic Metal Creations', 'PENDING', 7305,
        '98.58', '214.30'),

       (3, '1996 Moto Guzzi 1100i', 'Motorcycles', 599302, '1:10', 'Highway 66 Mini Classics', 'PENDING', 6625, '68.99',
        '118.94'),

       (4, '2003 Harley-Davidson Eagle Drag Bike', 'Motorcycles', 599302, '1:10', 'Red Start Diecast', 'PENDING', 5582,
        '91.02', '193.66'),

       (5, '1972 Alfa Romeo GTA', 'Classic Cars', 599302, '1:10', 'Motor City Art Classics', 'PENDING', 3252, '85.68',
        '136.00'),

       (6, '1962 LanciaA Delta 16V', 'Classic Cars', 599302, '1:10', 'Welly Diecast Productions', 'PENDING', 6791,
        '103.42', '147.74'),

       (7, '1968 Ford Mustang', 'Classic Cars', 599302, '1:12', 'Autoart Studio Design',
       ...
       (8, '2001 Ferrari Enzo', 'Classic Cars', 599302, '1:12', 'Second Gear Diecast',
       ...
       (9, '1958 Setra Bus', 'Trucks and Buses', 569331, '1:12', 'Welly Diecast Productions',
        'Model features 30 windows, skylights & glare resistant glass, working steering system, original logos', 1579,
        '77.90', '136.67'),

       (10, '2002 Suzuki XREO', 'Motorcycles', 599302, '1:12', 'Unimax Art Galleries',
       ...
       (11, '1969 Corvair Monza', 'Classic Cars', 599302, '1:18', 'Welly Diecast Productions',
        '1:18 scale die-cast about 10" long doors open, hood opens, trunk opens and wheels roll', 6906, '89.14',
        '151.08'),

       (12, '1968 Dodge Charger', 'Classic Cars', 599302, '1:12', 'Welly Diecast Productions',
       ...
       (13, '1969 Ford Falcon', 'Classic Cars', 599302, '1:12', 'Second Gear Diecast',
        'Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',
        1049, '83.05', '173.02'),

       (14, '1970 Plymouth Hemi Cuda', 'Classic Cars', 599302, '1:12', 'Studio M Art Models',
       ...
       (15, '1957 Chevy Pickup', 'Trucks and Buses', 569331, '1:12', 'Exoto Designs',
        '1:12 scale die-cast about 20" long Hood opens, Rubber wheels', 6125, '55.70', '118.50'),

       (16, '1969 Dodge Charger', 'Classic Cars', 599302, '1:12', 'Welly Diecast Productions',
       ...
       (17, '1940 Ford Pickup Truck', 'Trucks and Buses', 569331, '1:18', 'Studio M Art Models',
       ...
       (18, '1993 Mazda RX-7', 'Classic Cars', 599302, '1:18', 'Highway 66 Mini Classics',
       ...
       (19, '1937 Lincoln Berline', 'Vintage Cars', 223113, '1:18', 'Motor City Art Classics',
        'Features opening engine cover, doors, trunk, and fuel filler cap. Color black', 8693, '60.62', '102.74'),

       (20, '1936 Mercedes-Benz 500K Special Roadster', 'Vintage Cars', 223113, '1:18', 'Studio M Art Models',
       ...
       (21, '1965 Aston Martin DB5', 'Classic Cars', 599302, '1:18', 'Classic Metal Creations',
       ...
       (22, '1980s Black Hawk Helicopter', 'Planes', 433823, '1:18', 'Red Start Diecast',
       ...
       (23, '1917 Grand Touring Sedan', 'Vintage Cars', 223113, '1:18', 'Welly Diecast Productions',
       ...
       (24, '1948 Porsche 356-A Roadster', 'Classic Cars', 599302, '1:18', 'Gearbox Collectibles',
       ...
       (25, '1995 Honda Civic', 'Classic Cars', 599302, '1:18', 'Min Lin Diecast',
       ...
       (26, '1998 Chrysler Plymouth Prowler', 'Classic Cars', 599302, '1:18', 'Gearbox Collectibles',
        'Turnable front wheels; steering create function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',
        4724, '101.51', '163.73'),

       (27, '1911 Ford Town Car', 'Vintage Cars', 223113, '1:18', 'Motor City Art Classics',
        'Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system.',
        540, '33.30', '60.54'),

       (28, '1964 Mercedes Tour Bus', 'Trucks and Buses', 569331, '1:18', 'Unimax Art Galleries',
        'Exact replica. 100+ parts. working steering system, original logos', 8258, '74.86', '122.73'),

       (29, '1932 Model A Ford J-Coupe', 'Vintage Cars', 223113, '1:18', 'Autoart Studio Design',
       ...
       (30, '1926 Ford Fire Engine', 'Trucks and Buses', 569331, '1:18', 'Carousel DieCast Legends',
        'Gleaming red handsome appearance. Everything is here the fire hoses, ladder, axes, bells, lanterns, ready to fight any inferno.',
        2018, '24.92', '60.77'),

       (31, 'P-51-D Mustang', 'Planes', 433823, '1:72', 'Gearbox Collectibles',
        'Has retractable wheels and comes with a stand', 992, '49.00', '84.48'),

       (32, '1936 Harley Davidson El Knucklehead', 'Motorcycles', 599302, '1:18', 'Welly Diecast Productions',
        'Intricately detailed with chrome accents and trim, official die-struck logos and baked enamel finish.', 4357,
        '24.23', '60.57'),

       (33, '1928 Mercedes-Benz SSK', 'Vintage Cars', 223113, '1:18', 'Gearbox Collectibles',
       ...
       (34, '1999 Indy 500 Monte Carlo SS', 'Classic Cars', 599302, '1:18', 'Red Start Diecast',
       ...
       (36, '1934 Ford V8 Coupe', 'Vintage Cars', 223113, '1:18', 'Min Lin Diecast',
        'Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System',
        5649, '34.35', '62.46'),

       (37, '1999 Yamaha Speed Boat', 'Ships', 433823, '1:18', 'Min Lin Diecast',
       ...
       (38, '18th Century Vintage Horse Carriage', 'Vintage Cars', 223113, '1:18', 'Red Start Diecast',
        'Hand crafted diecast-like metal horse carriage is re-created in about 1:18 scale of antique horse carriage. This antique style metal Stagecoach is all hand-assembled with many different parts.rnrnThis collectible metal horse carriage is painted in classic Red, and features turning steering wheel and is entirely hand-finished.',
        5992, '60.74', '104.72'),

       (39, '1903 Ford Model A', 'Vintage Cars', 223113, '1:18', 'Unimax Art Galleries',
        'Features opening trunk, working steering system', 3913, '68.30', '136.59'),

       (40, '1992 Ferrari 360 Spider red', 'Classic Cars', 599302, '1:18', 'Unimax Art Galleries',
       ...
       (41, '1985 Toyota Supra', 'Classic Cars', 599302, '1:18', 'Highway 66 Mini Classics',
        'This model features soft rubber tires, working steering, rubber mud guards, authentic Ford logos, detailed undercarriage, opening doors and hood, removable split rear gate, full size spare mounted in bed, detailed interior with opening glove box',
        7733, '57.01', '107.57'),
       ...
       (43, '1969 Dodge Super Bee', 'Classic Cars', 599302, '1:18', 'Min Lin Diecast',
       ...
       (44, '1917 Maxwell Touring Car', 'Vintage Cars', 223113, '1:18', 'Exoto Designs',
       ...
       (45, '1976 Ford Gran Torino', 'Classic Cars', 599302, '1:18', 'Gearbox Collectibles',
       ...
       (46, '1948 Porsche Type 356 Roadster', 'Classic Cars', 599302, '1:18', 'Gearbox Collectibles',
       ...
       (47, '1957 Vespa GS150', 'Motorcycles', 599302, '1:18', 'Studio M Art Models',
        'Features rotating wheels , working kick stand. Comes with stand.', 7689, '32.95', '62.17'),

       (48, '1941 Chevrolet Special Deluxe Cabriolet', 'Vintage Cars', 223113, '1:18', 'Exoto Designs',
       ...
       (49, '1970 Triumph Spitfire', 'Classic Cars', 599302, '1:18', 'Min Lin Diecast',
        'Features include opening and closing doors. Color: White.', 5545, '91.92', '143.62'),

       (50, '1932 Alfa Romeo 8C2300 Spider Sport', 'Vintage Cars', 223113, '1:18', 'Exoto Designs',
       ...
       (51, '1904 Buick Runabout', 'Vintage Cars', 223113, '1:18', 'Exoto Designs',
        'Features opening trunk, working steering system', 8290, '52.66', '87.77'),

       (52, '1940s Ford truck', 'Trucks and Buses', 569331, '1:18', 'Motor City Art Classics',
       ...
       (53, '1939 Cadillac Limousine', 'Vintage Cars', 223113, '1:18', 'Studio M Art Models',
       ...
       (54, '1957 Corvette Convertible', 'Classic Cars', 599302, '1:18', 'Classic Metal Creations',
       ...
       (55, '1957 Ford Thunderbird', 'Classic Cars', 599302, '1:18', 'Studio M Art Models',
       ...
       (56, '1970 Chevy Chevelle SS 454', 'Classic Cars', 599302, '1:24', 'Unimax Art Galleries',
       ...
       (57, '1970 Dodge Coronet', 'Classic Cars', 599302, '1:24', 'Highway 66 Mini Classics',
        '1:24 scale die-cast about 18" long doors open, hood opens and rubber wheels', 4074, '32.37', '57.80'),

       (58, '1997 BMW R 1100 S', 'Motorcycles', 599302, '1:24', 'Autoart Studio Design',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 7003, '60.86', '112.70'),

       (59, '1966 Shelby Cobra 427 S/C', 'Classic Cars', 599302, '1:24', 'Carousel DieCast Legends',
       ...
       (60, '1928 British Royal Navy Airplane', 'Planes', 433823, '1:24', 'Classic Metal Creations',
        'Official logos and insignias', 3627, '66.74', '109.42'),

       (61, '1939 Chevrolet Deluxe Coupe', 'Vintage Cars', 223113, '1:24', 'Motor City Art Classics',
       ...
       (62, '1960 BSA Gold Star DBD34', 'Motorcycles', 599302, '1:24', 'Highway 66 Mini Classics',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 15, '37.32', '76.17'),

       (63, '18th century schooner', 'Ships', 433823, '1:24', 'Carousel DieCast Legends',
       ...
       (64, '1938 Cadillac V-16 Presidential Limousine', 'Vintage Cars', 223113, '1:24', 'Classic Metal Creations',
       ...
       (65, '1962 Volkswagen Microbus', 'Trucks and Buses', 569331, '1:24', 'Autoart Studio Design',
       ...
       (66, '1982 Ducati 900 Monster', 'Motorcycles', 599302, '1:24', 'Highway 66 Mini Classics',
        'Features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand',
        6840, '47.10', '69.26'),

       (67, '1949 Jaguar XK 120', 'Classic Cars', 599302, '1:24', 'Classic Metal Creations',
       ...
       (68, '1958 Chevy Corvette Limited Edition', 'Classic Cars', 599302, '1:24', 'Carousel DieCast Legends',
       ...
       (69, '1900s Vintage Bi-Plane', 'Planes', 433823, '1:24', 'Autoart Studio Design',
       ...
       (70, '1952 Citroen-15CV', 'Classic Cars', 599302, '1:24', 'Exoto Designs',
       ...
       (71, '1982 Lamborghini Diablo', 'Classic Cars', 599302, '1:24', 'Second Gear Diecast',
        'This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.',
        7723, '16.24', '37.76'),

       (72, '1912 Ford Model T Delivery Wagon', 'Vintage Cars', 223113, '1:24', 'Min Lin Diecast',
       ...
       (73, '1969 Chevrolet Camaro Z28', 'Classic Cars', 599302, '1:24', 'Exoto Designs',
       ...
       (74, '1971 Alpine Renault 1600s', 'Classic Cars', 599302, '1:24', 'Welly Diecast Productions',
       ...
       (75, '1937 Horch 930V Limousine', 'Vintage Cars', 223113, '1:24', 'Autoart Studio Design',
        'Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system',
        2902, '26.30', '65.75'),

       (76, '2002 Chevy Corvette', 'Classic Cars', 599302, '1:24', 'Gearbox Collectibles',
       ...
       (77, '1940 Ford Delivery Sedan', 'Vintage Cars', 223113, '1:24', 'Carousel DieCast Legends',
        'Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System. Color black.',
        6621, '48.64', '83.86'),

       (78, '1956 Porsche 356A Coupe', 'Classic Cars', 599302, '1:18', 'Classic Metal Creations',
        'Features include: Turnable front wheels; steering create function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',
        6600, '98.30', '140.43'),

       (79, 'Corsair F4U ( Bird Cage)', 'Planes', 433823, '1:24', 'Second Gear Diecast',
        'Has retractable wheels and comes with a stand. Official logos and insignias.', 6812, '29.34', '68.24'),

       (80, '1936 Mercedes Benz 500k Roadster', 'Vintage Cars', 223113, '1:24', 'Red Start Diecast',
       ...
       (81, '1992 Porsche Cayenne Turbo Silver', 'Classic Cars', 599302, '1:24', 'Exoto Designs',
        'This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.',
        6582, '69.78', '118.28'),

       (82, '1936 Chrysler Airflow', 'Vintage Cars', 223113, '1:24', 'Second Gear Diecast',
        'Features opening trunk, working steering system. Color dark green.', 4710, '57.46', '97.39'),

       (83, '1900s Vintage Tri-Plane', 'Planes', 433823, '1:24', 'Unimax Art Galleries',
       ...
       (84, '1961 Chevrolet Impala', 'Classic Cars', 599302, '1:18', 'Classic Metal Creations',
       ...
       (85, '1980’s GM Manhattan Express', 'Trucks and Buses', 569331, '1:32', 'Motor City Art Classics',
       ...
       (86, '1997 BMW F650 ST', 'Motorcycles', 599302, '1:32', 'Exoto Designs',
        'Features official die-struck logos and baked enamel finish. Comes with stand.', 178, '66.92', '99.89'),

       (87, '1982 Ducati 996 R', 'Motorcycles', 599302, '1:32', 'Gearbox Collectibles',
        'Features rotating wheels , working kick stand. Comes with stand.', 9241, '24.14', '40.23'),

       (88, '1954 Greyhound Scenicruiser', 'Trucks and Buses', 569331, '1:32', 'Classic Metal Creations',
        'Model features bi-level seating, 50 windows, skylights & glare resistant glass, working steering system, original logos',
        2874, '25.98', '54.11'),

       (89, '1950''s Chicago Surface Lines Streetcar', 'Trains', 123333, '1:32', 'Gearbox Collectibles',
       ...
       (90, '1996 Peterbilt 379 Stake Bed with Outrigger', 'Trucks and Buses', 569331, '1:32', 'Red Start Diecast',
       ...
       (91, '1928 Ford Phaeton Deluxe', 'Vintage Cars', 223113, '1:32', 'Highway 66 Mini Classics',
        'This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system',
        136, '33.02', '68.79'),

       (92, '1974 Ducati 350 Mk3 Desmo', 'Motorcycles', 599302, '1:32', 'Second Gear Diecast',
        'This model features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand',
        3341, '56.13', '102.05'),

       (93, '1930 Buick Marquette Phaeton', 'Vintage Cars', 223113, '1:50', 'Studio M Art Models',
        'Features opening trunk, working steering system', 7062, '27.06', '43.64'),

       (94, 'Diamond T620 Semi-Skirted Tanker', 'Trucks and Buses', 569331, '1:50', 'Highway 66 Mini Classics',
        'This limited edition model is licensed and perfectly scaled for Lionel Trains. The Diamond T620 has been produced in solid precision diecast and painted with a fire baked enamel finish. It comes with a removable tanker and is a perfect model to add authenticity to your static train or car layout or to just have on display.',
        1016, '68.29', '115.75'),

       (95, '1962 City of Detroit Streetcar', 'Trains', 123333, '1:50', 'Classic Metal Creations',
       ...
       (96, '2002 Yamaha YZR M1', 'Motorcycles', 599302, '1:50', 'Autoart Studio Design',
        'Features rotating wheels , working kick stand. Comes with stand.', 600, '34.17', '81.36'),

       (97, 'The Schooner Bluenose', 'Ships', 433823, '1:700', 'Autoart Studio Design',
        'All wood with canvas sails. Measures 31 1/2 inches in Length, 22 inches High and 4 3/4 inches Wide. Many extras.rnThe schooner Bluenose was built in Nova Scotia in 1921 to fish the rough waters off the coast of Newfoundland. Because of the Bluenose racing prowess she became the pride of all Canadians. Still featured on stamps and the Canadian dime, the Bluenose was lost off Haiti in 1946.',
        1897, '34.00', '66.67'),

       (98, 'American Airlines: B767-300', 'Planes', 433823, '1:700', 'Min Lin Diecast',
        'Exact replia with official logos and insignias and retractable wheels', 5841, '51.15', '91.34'),

       (99, 'The Mayflower', 'Ships', 433823, '1:700', 'Studio M Art Models',
        'Measures 31 1/2 inches Long x 25 1/2 inches High x 10 5/8 inches WidernAll wood with canvas sail. Extras include long boats, rigging, ladders, railing, anchors, side cannons, hand painted, etc.',
        737, '43.30', '86.61'),

       (100, 'HMS Bounty', 'Ships', 433823, '1:700', 'Unimax Art Galleries',
        'Measures 30 inches Long x 27 1/2 inches High x 4 3/4 inches Wide. rnMany extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.',
        3501, '39.83', '90.52'),

       (101, 'America West Airlines B757-200', 'Planes', 433823, '1:700', 'Motor City Art Classics',
        'Official logos and insignias. Working steering system. Rotating jet engines', 9653, '68.80', '99.72'),

       (102, 'The USS Constitution Ship', 'Ships', 433823, '1:700', 'Red Start Diecast',
       ...
       (103, '1982 Camaro Z28', 'Classic Cars', 599302, '1:18', 'Carousel DieCast Legends',
        'Features include opening and closing doors. Color: White. rnMeasures approximately 9 1/2" Long.', 6934,
        '46.53', '101.15'),

       (104, 'ATA: B757-300', 'Planes', 433823, '1:700', 'Highway 66 Mini Classics',
        'Exact replia with official logos and insignias and retractable wheels', 7106, '59.33', '118.65'),

       (105, 'F/A 18 Hornet 1/72', 'Planes', 433823, '1:72', 'Motor City Art Classics',
        '10" Wingspan with retractable landing gears.Comes with pilot', 551, '54.40', '80.00'),

       (106, 'The Titanic', 'Ships', 433823, '1:700', 'Carousel DieCast Legends',
        'Completed model measures 19 1/2 inches long, 9 inches high, 3inches wide and is in barn red/black. All wood and metal.',
        1956, '51.09', '100.17'),

       (107, 'The Queen Mary', 'Ships', 433823, '1:700', 'Welly Diecast Productions',
        'Exact replica. Wood and Metal. Many extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.',
        5088, '53.63', '99.31'),

       (108, 'American Airlines: MD-11S', 'Planes', 433823, '1:700', 'Second Gear Diecast',
        'Polished finish. Exact replia with official logos and insignias and retractable wheels', 8820, '36.27',
        '74.03'),

       (109, 'Boeing X-32A JSF', 'Planes', 433823, '1:72', 'Motor City Art Classics',
        '10" Wingspan with retractable landing gears.Comes with pilot', 4857, '32.77', '49.66'),

       (110, 'Pont Yacht', 'Ships', 433823, '1:72', 'Unimax Art Galleries',
        'Measures 38 inches Long x 33 3/4 inches High. Includes a stand.rnMany extras including rigging, long boats, pilot house, anchors, etc. Comes with 2 masts, all square-rigged',
        414, '33.30', '54.60')
ON CONFLICT ("product_id") DO NOTHING;

/* Data for the table "order" */

insert into "order"("order_id", "order_date", "required_date", "shipped_date", "status", "comments", "customer_number",
                    "amount")
values (10100, '2003-01-06', '2003-01-13', '2003-01-10', 'Shipped', NULL, 363, 301.84),
       ...
       (10107, '2003-02-24', '2003-03-03', '2003-02-26', 'Shipped',
        'Difficult to negotiate with customer. We need more marketing materials', 131, 793.21),

       (10108, '2003-03-03', '2003-03-12', '2003-03-08', 'Shipped', NULL, 385, 1267.48),

       (10109, '2003-03-10', '2003-03-19', '2003-03-11', 'Shipped',
        'Customer requested that FedEx Ground is used for this shipping', 486, 700.89),
       ...
       (10112, '2003-03-24', '2003-04-03', '2003-03-29', 'Shipped',
        'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 144, 282.26),
       ...
       (10118, '2003-04-21', '2003-04-29', '2003-04-26', 'Shipped',
        'Customer has worked with some of our vendors in the past and is aware of their MSRP', 216, 86.15),
       ...
       (10127, '2003-06-03', '2003-06-09', '2003-06-06', 'Shipped',
        'Customer requested special shippment. The instructions were passed along to the warehouse', 151, 1601.39),
       ...
       (10136, '2003-07-04', '2003-07-14', '2003-07-06', 'Shipped',
        'Customer is interested in buying more Ferrari models', 242, 407.73),
       ...
       (10143, '2003-08-10', '2003-08-18', '2003-08-12', 'Shipped',
        'Can we deliver the new Ford Mustang models by end-of-quarter?', 320, 1227.49),
       ...
       (10148, '2003-09-11', '2003-09-21', '2003-09-15', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 276, 1374.9),

       (10149, '2003-09-12', '2003-09-18', '2003-09-17', 'Shipped', NULL, 487, 925.52),

       (10150, '2003-09-19', '2003-09-27', '2003-09-21', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 148, 1096.9),
       ...
       (10164, '2003-10-21', '2003-10-30', '2003-10-23', 'Resolved',
        'This order was disputed, but resolved on 11/1/2003; Customer does not like the colors and precision of the models.',
        452, 758.85),

       (10165, '2003-10-22', '2003-10-31', '2003-12-26', 'Shipped',
        'This order was on hold because customer credit limit had been exceeded. Order will ship when payment is received',
        148, 1674.66),

       (10166, '2003-10-21', '2003-10-30', '2003-10-27', 'Shipped', NULL, 462, 361.88),

       (10167, '2003-10-23', '2003-10-30', NULL, 'Cancelled',
        'Customer called to cancel. The warehouse was notified in time and the order did not ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',
        448, 1271.62),
       ...
       (10186, '2003-11-14', '2003-11-20', '2003-11-18', 'Shipped',
        'They want to reevaluate their terms agreement with the VP of Sales', 489, 729.73),
       ...
       (10189, '2003-11-18', '2003-11-25', '2003-11-24', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 205, 138.57),
       ...
       (10197, '2003-11-26', '2003-12-02', '2003-12-01', 'Shipped',
        'Customer inquired about remote controlled models and gold models.', 216, 1109.13),
       ...
       (10205, '2003-12-03', '2003-12-09', '2003-12-07', 'Shipped',
        ' I need all the information I can get on our competitors.', 141, 347.45),
       ...
       (10213, '2004-01-22', '2004-01-28', '2004-01-27', 'Shipped',
        'Difficult to negotiate with customer. We need more marketing materials', 489, 240.59),

       (10214, '2004-01-26', '2004-02-04', '2004-01-29', 'Shipped', NULL, 458, 623.43),

       (10215, '2004-01-29', '2004-02-08', '2004-02-01', 'Shipped',
        'Customer requested that FedEx Ground is used for this shipping', 475, 916.49),
       ...
       (10218, '2004-02-09', '2004-02-16', '2004-02-11', 'Shipped',
        'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 473, 262.87),
       ...
       (10224, '2004-02-21', '2004-03-02', '2004-02-26', 'Shipped',
        'Customer has worked with some of our vendors in the past and is aware of their MSRP', 171, 472.32),
       ...
       (10233, '2004-03-29', '2004-04-04', '2004-04-02', 'Shipped',
        'Customer requested special shippment. The instructions were passed along to the warehouse', 328, 204.75),
       ...
       (10242, '2004-04-20', '2004-04-28', '2004-04-25', 'Shipped',
        'Customer is interested in buying more Ferrari models', 456, 36.52),
       ...
       (10248, '2004-05-07', '2004-05-14', NULL, 'Cancelled',
        'Order was mistakenly placed. The warehouse noticed the lack of documentation.', 131, 1263.34),

       (10249, '2004-05-08', '2004-05-17', '2004-05-11', 'Shipped',
        'Can we deliver the new Ford Mustang models by end-of-quarter?', 173, 344.64),
       ...
       (10254, '2004-06-03', '2004-06-13', '2004-06-04', 'Shipped',
        'Customer requested that DHL is used for this shipping', 323, 983.52),
       ...
       (10262, '2004-06-24', '2004-07-01', NULL, 'Cancelled',
        'This customer found a better offer from one of our competitors. Will call back to renegotiate.', 141, 1217.38),

       (10263, '2004-06-28', '2004-07-04', '2004-07-02', 'Shipped', NULL, 175, 1078.64),

       (10264, '2004-06-30', '2004-07-06', '2004-07-01', 'Shipped',
        'Customer will send a truck to our local warehouse on 7/1/2004', 362, 526.81),
       ...
       (10292, '2004-09-08', '2004-09-18', '2004-09-11', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 131, 1074.32),
       ...
       (10295, '2004-09-10', '2004-09-17', '2004-09-14', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 362, 446.8),
       ...
       (10303, '2004-10-06', '2004-10-14', '2004-10-09', 'Shipped',
        'Customer inquired about remote controlled models and gold models.', 484, 92.61),
       ...
       (10308, '2004-10-15', '2004-10-24', '2004-10-20', 'Shipped',
        'Customer requested that FedEx Ground is used for this shipping', 319, 1334.48),
       ...
       (10311, '2004-10-16', '2004-10-23', '2004-10-20', 'Shipped',
        'Difficult to negotiate with customer. We need more marketing materials', 141, 1033.82),

       (10312, '2004-10-21', '2004-10-27', '2004-10-23', 'Shipped', NULL, 124, 1494.19),

       (10313, '2004-10-22', '2004-10-28', '2004-10-25', 'Shipped',
        'Customer requested that FedEx Ground is used for this shipping', 202, 1088.17),
       ...
       (10316, '2004-11-01', '2004-11-09', '2004-11-07', 'Shipped',
        'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 240, 1375.59),
       ...
       (10319, '2004-11-03', '2004-11-11', '2004-11-06', 'Shipped',
        'Customer requested that DHL is used for this shipping', 456, 742.37),
       ...
       (10322, '2004-11-04', '2004-11-12', '2004-11-10', 'Shipped',
        'Customer has worked with some of our vendors in the past and is aware of their MSRP', 363, 1345.23),
       ...
       (10327, '2004-11-10', '2004-11-19', '2004-11-13', 'Resolved',
        'Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models do not match what was discussed.',
        145, 665.06),
       ...
       (10331, '2004-11-17', '2004-11-23', '2004-11-23', 'Shipped',
        'Customer requested special shippment. The instructions were passed along to the warehouse', 486, 1451.43),
       ...
       (10336, '2004-11-20', '2004-11-26', '2004-11-24', 'Shipped',
        'Customer requested that DHL is used for this shipping', 172, 1357.7),
       ...
       (10340, '2004-11-24', '2004-12-01', '2004-11-25', 'Shipped',
        'Customer is interested in buying more Ferrari models', 216, 580.85),
       ...
       (10347, '2004-11-29', '2004-12-07', '2004-11-30', 'Shipped',
        'Can we deliver the new Ford Mustang models by end-of-quarter?', 114, 1240.73),
       ...
       (10358, '2004-12-10', '2004-12-16', '2004-12-16', 'Shipped',
        'Customer requested that DHL is used for this shipping', 141, 1297.97),
       ...
       (10367, '2005-01-12', '2005-01-21', '2005-01-16', 'Resolved',
        'This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx investigation proved this wrong.',
        205, 1072.73),
       ...
       (10386, '2005-03-01', '2005-03-09', '2005-03-06', 'Resolved',
        'Disputed then Resolved on 3/15/2005. Customer does not like the craftsmaship of the models.', 141, 1352.06),
       ...
       (10390, '2005-03-04', '2005-03-11', '2005-03-07', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 124, 1479.36),
       ...
       (10393, '2005-03-11', '2005-03-22', '2005-03-14', 'Shipped',
        'They want to reevaluate their terms agreement with Finance.', 323, 1067.87),
       ...
       (10400, '2005-04-01', '2005-04-11', '2005-04-04', 'Shipped',
        'Customer requested that DHL is used for this shipping', 450, 741.11),

       (10401, '2005-04-03', '2005-04-14', NULL, 'On Hold',
        'Customer credit limit exceeded. Will ship when a payment is received.', 328, 886.7),
       ...
       (10407, '2005-04-22', '2005-05-04', NULL, 'On Hold',
        'Customer credit limit exceeded. Will ship when a payment is received.', 450, 1074.29),
       ...
       (10413, '2005-05-05', '2005-05-14', '2005-05-09', 'Shipped',
        'Customer requested that DHL is used for this shipping', 175, 763.06),

       (10414, '2005-05-06', '2005-05-13', NULL, 'On Hold',
        'Customer credit limit exceeded. Will ship when a payment is received.', 362, 1163.89),

       (10415, '2005-05-09', '2005-05-20', '2005-05-12', 'Disputed',
        'Customer claims the scales of the models do not match what was discussed. I keep all the paperwork though to prove otherwise',
        471, 324.13),

       (10416, '2005-05-10', '2005-05-16', '2005-05-14', 'Shipped', NULL, 386, 1084.51),

       (10417, '2005-05-13', '2005-05-19', '2005-05-19', 'Disputed',
        'Customer does not like the colors and precision of the models.', 141, 671.33),
...
insert into "orderdetail"("order_id", "product_id", "quantity_ordered", "price_each", "order_line_number")
values (10100, 23, 30, '136.00', 3),
...
insert into "payment"("customer_number", "check_number", "payment_date", "invoice_amount", "caching_date")
values (103, 'HQ336336', '2004-10-19 12:00:01', '6066.78', '2004-10-19 12:30:15'),
...
ON CONFLICT ("customer_number", "check_number") DO NOTHING;

/* Data for the table "bank_transaction" */

insert into "bank_transaction"("transaction_id", "bank_name", "bank_iban", "transfer_amount", "customer_number",
                               "check_number", "caching_date", "card_type", "status")
values (1, 'Bank Ltd. US', 'DN44398834N34', '6631.36', 447, 'AO757239', '2003-09-15 18:22:54', 'VisaElectron',
        'SUCCESS'),

       (2, 'Bank Ltd. US', '348398H3493HG93', '26304.13', 447, 'OU516561', '2004-12-17 16:45:22', 'VisaElectron',
        'FAILED'),

       (3, 'Transilvania Bank', '8TVN598N454VN84T', '9977.85', 462, 'GC60330', '2003-11-08 18:57:25', 'VisaElectron',
        'SUCCESS'),

       (4, '5 Stars Bank', '8VN8UNT5U45T8', '48355.87', 462, 'PE176846', '2004-11-27 14:30:22', 'VisaElectron',
        'SUCCESS'),

       (5, '5 Stars Bank', 'TVU58NU58U84N4YUG', '33967.73', 398, 'AJ478695', '2005-02-14 12:09:15', 'VisaElectron',
        'FAILED'),

       (6, 'Optimus Bank', '8V34VN5U435334', '4588.36', 333, 'NF959653', '2005-03-01 12:12:00', 'VisaElectron',
        'UNAUTHORIZED'),

       (7, 'Optimus Bank', '8V34VN5U435334', '8987.36', 333, 'NF959653', '2005-03-01 14:00:00', 'MasterCard',
        'UNAUTHORIZED'),

       (8, 'Optimus Bank', '8V34VN5U435334', '2544.36', 333, 'NF959653', '2005-03-01 18:20:10', 'VisaElectron',
        'FAILED'),

       (9, 'Optimus Bank', '8V34VN5U435334', '5312.23', 333, 'NF959653', '2005-03-01 19:32:56', 'MasterCard',
        'RETRIED'),

       (10, '5 Stars Bank', '8VN8UNT5U45T8', '3382.13', 462, 'GC60330', '2004-07-01 12:31:56', 'VisaElectron',
        'SUCCESS'),

       (11, '5 Stars Bank', '8VN8UNT5U45T8', '2566.17', 462, 'GC60330', '2004-07-03 11:21:16', 'VisaElectron',
        'SUCCESS'),

       (12, 'Bank Ltd. US', '348398H3493HG93', '12304.13', 447, 'OU516561', '2004-12-27 16:15:22', 'VisaElectron',
        'SUCCESS'),

       (13, 'BRT Bank', 'TVNU343T38TUNU3T', '52151.81', 278, 'GP636783', '2003-03-02 12:32:00', 'MasterCard', 'FAILED'),

       (14, 'Optimus Bank', 'GH390439i344F', '56321.33', 124, 'AE215433', '2005-03-05 12:32:56', 'VisaElectron',
        'SUCCESS'),

       (15, 'Optimus Bank', 'GH390439i344F', '9866.21', 124, 'AE215433', '2005-03-05 13:00:00', 'VisaElectron',
        'SUCCESS'),

       (16, 'Optimus Bank', 'GH390439i344F', '35057.05', 124, 'AE215433', '2005-03-05 14:12:00', 'VisaElectron',
        'SUCCESS'),

       (17, '5 Stars Bank', 'QQQ333330944', '6522.99', 141, 'IN446258', '2005-03-25 13:44:11', 'VisaElectron',
        'SUCCESS'),

       (18, '5 Stars Bank', 'QQQ333330944', '2566.17', 141, 'IN446258', '2005-03-25 14:00:05', 'VisaElectron',
        'SUCCESS'),

       (19, '5 Stars Bank', 'QQQ333330944', '15800.30', 141, 'IN446258', '2005-03-25 14:03:05', 'VisaElectron',
        'SUCCESS'),

       (20, '5 Stars Bank', 'QQQ333330944', '21455.32', 141, 'IN446258', '2005-03-25 15:13:05', 'VisaElectron',
        'SUCCESS'),

       (21, '5 Stars Bank', 'QQQ333330944', '9883.22', 141, 'IN446258', '2005-03-25 15:25:05', 'VisaElectron',
        'SUCCESS'),

       (22, '5 Stars Bank', 'QQQ333330944', '8843.26', 141, 'IN446258', '2005-03-25 16:00:05', 'VisaElectron',
        'SUCCESS')
ON CONFLICT ("transaction_id") DO NOTHING;

/* Data for the table "sale" */

insert into "sale"("sale_id", "fiscal_year", "sale", "employee_number", "fiscal_month", "revenue_growth", "trend")
values (1, 2003, 5282.64, 1370, 1, 0, 'CONSTANT'),
...
insert into "top3product"("product_id", "product_name")
values (40, '1992 Ferrari 360 Spider red'),
...
insert into "token"("token_id", "sale_id", "amount")
values (1, 1, 1500),
...
insert into "employee_status"("employee_number", "status", "acquired_date")
values (1002, 'REGULAR', '2004-04-14'),

       (1056, 'REGULAR', '2003-06-10'),

       (1076, 'REGULAR', '2005-01-10'),

       (1088, 'REGULAR', '2005-04-10'),

       (1102, 'REGULAR', '2003-07-12'),

       (1143, 'REGULAR', '2003-05-12'),

       (1143, 'AVERAGE', '2004-12-05'),

       (1165, 'REGULAR', '2005-11-15'),

       (1166, 'REGULAR', '2003-06-15'),

       (1166, 'AVERAGE', '2004-11-15'),

       (1188, 'REGULAR', '2003-10-25'),

       (1216, 'REGULAR', '2003-11-25'),

       (1286, 'REGULAR', '2004-09-25'),

       (1323, 'REGULAR', '2006-01-25'),

       (1337, 'REGULAR', '2003-02-23'),

       (1370, 'REGULAR', '2000-02-23'),

       (1370, 'AVERAGE', '2002-06-21'),

       (1370, 'GOOD', '2004-01-11'),

       (1370, 'EXCELLENT', '2005-11-11'),

       (1401, 'REGULAR', '2005-10-11'),

       (1401, 'AVERAGE', '2006-02-12'),

       (1501, 'REGULAR', '2004-02-12'),

       (1501, 'AVERAGE', '2005-02-12'),

       (1504, 'REGULAR', '2003-02-12'),

       (1504, 'AVERAGE', '2006-02-12'),

       (1504, 'GOOD', '2007-06-10'),

       (1611, 'REGULAR', '2003-01-10'),

       (1611, 'AVERAGE', '2004-05-17'),

       (1611, 'GOOD', '2005-03-22'),

       (1611, 'EXCELLENT', '2007-03-20'),

       (1612, 'REGULAR', '2003-01-22'),

       (1612, 'AVERAGE', '2004-05-11'),

       (1619, 'REGULAR', '2000-05-11'),

       (1619, 'AVERAGE', '2001-05-11'),

       (1619, 'GOOD', '2004-01-15'),

       (1621, 'REGULAR', '2004-03-15'),

       (1621, 'AVERAGE', '2005-12-15'),

       (1625, 'REGULAR', '2002-12-15'),

       (1702, 'REGULAR', '2002-11-25'),

       (1702, 'AVERAGE', '2004-09-02')
ON CONFLICT ("id") DO NOTHING;

/* Data for the table "daily_activity" */

insert into "daily_activity"("day_id", "day_date", "sales", "visitors", "conversion")
values (1, '2004-01-01', 21, 3373, 0.62),
...
insert into "office_flights"("depart_town", "arrival_town", "distance_km")
values ('Paris', 'Los Angeles', 9080),
       ...
       ('Tokyo', 'London', 9559)
ON CONFLICT ("depart_town", "arrival_town") DO NOTHING;
